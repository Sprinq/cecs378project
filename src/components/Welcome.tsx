...
export default function Welcome() {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 text-center h-full">
      ...
      <h1 className="text-3xl font-bold text-white mb-2">Welcome to SecureChat</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-2xl">
        ...
        >
          ...
          <p className="text-gray-400 text-sm text-center">Chat in topic-based channels</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-400 text-sm text-center">Connect with people you know</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-400 text-sm text-center">Chat privately with friends</p>
        </div>
      </div>
    </div>
  );
