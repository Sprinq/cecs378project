      ...
      <div className="w-full max-w-md bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            className={`w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200 ${
